...
export const contributes = `<b>I'm so happy that you wanted to upgrade me, but starting from 2021th year, Mad Maids decided to contribute me on private. However, you can join our organization and be able to contribute me then!</b>`;

export const clubs = `<b>Here are the clubs:</b>`;
